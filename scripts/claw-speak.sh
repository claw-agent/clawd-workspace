#!/bin/bash
# Claw Voice - TTS with Tim Gerard Reynolds voice clone
# Usage: ./claw-speak.sh "Text to speak" [output.wav] [--temp 1.2] [--top-p 0.9]
#
...
echo "🎙️ Claw Voice TTS starting..."
echo "   Text: ${TEXT:0:50}..."
echo "   Output: $OUTPUT"
...
# Uses simple mode (x-vector only) since no reference transcript
